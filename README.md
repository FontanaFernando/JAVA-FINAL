...
Asegúrate de tener el servicio de MySQL iniciado en tu sistema.
Crea la base de datos vacía ejecutando en tu terminal o Workbench:
CREATE DATABASE techlab_db;
Configura tus credenciales locales en el archivo src/main/resources/application.properties.
Ejecuta la aplicación desde la terminal de tu IDE con el comando:
mvn spring-boot:run
